...
public interface TypeCache {
    ...
    public static class CacheBuilder {
        ...
        public CacheBuilder withClassName(String className) {
            return new CacheBuilder(this.cachePackage, this.cacheCategory, ImmutableList.<String>builder().addAll(this.className).add(this.formatClass(className)).build(), this.fieldName, this.methods, this.additionalData, this.parameterTypes, this.expectType);
        }

        public CacheBuilder withClassName(Class<?> clazz) {
            return new CacheBuilder(this.cachePackage, this.cacheCategory, ImmutableList.<String >builder().addAll(this.className).add(clazz == null ? "" : clazz.getName()).build(), this.fieldName, this.methods, this.additionalData, this.parameterTypes, this.expectType);
        }

        public CacheBuilder withMethodName(String methodName) {
            return new CacheBuilder(this.cachePackage, this.cacheCategory, this.className, this.fieldName, ImmutableList.<String>builder().addAll(this.methods).add(methodName).build(), this.additionalData, this.parameterTypes, this.expectType);
        }
        ...
        public CacheBuilder withParameterTypes(Class<?>... types) {
            return new CacheBuilder(this.cachePackage, this.cacheCategory, this.className, this.fieldName, this.methods, this.additionalData, Iterables.concat(this.parameterTypes, ImmutableList.of(types)), this.expectType);
        }
