...
public class NPCAction {
    private final NPCAction.ActionType actionType;
    private final ClickType clickType;
    private final String action;
    private int delay;

    public NPCAction(NPCAction.ActionType actionType, ClickType clickType, String action, int delay) {
    ...
    public NPCAction(String actionType, String action) {
        this(NPCAction.ActionType.valueOf(actionType), ClickType.DEFAULT, action, 0);
    }

    public NPCAction.ActionType getActionType() {
