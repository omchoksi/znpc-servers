...
public class Hologram {
    ...
    public void createHologram() {
        ...
        try {
            ...
            for(Iterator var4 = this.npc.getNpcPojo().getHologramLines().iterator(); var4.hasNext(); y += LINE_SPACING) {
                ...
                this.hologramLines.add(new HologramLine(line.replace(ConfigurationConstants.SPACE_SYMBOL, " "), armorStand, (Integer)((Method)CacheRegistry.GET_ENTITY_ID.load()).invoke(armorStand)));
            }
    ...
    public void updateNames(ZUser user) {
        ...
        while(var2.hasNext()) {
            HologramLine hologramLine = (HologramLine)var2.next();
    ...
    public void setLocation(Location location, double height) {
        ...
        try {
            ...
            for(Iterator var6 = this.hologramLines.iterator(); var6.hasNext(); y += LINE_SPACING) {
                HologramLine hologramLine = (HologramLine)var6.next();
